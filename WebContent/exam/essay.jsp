...
<script type="text/javascript">
	...
	function submitForm(actionType){
		$('#questionForm').ajaxSubmit({
			type: 'post',
			url:'${ctx}/exam/essay!'+actionType+'.action',			
		...
		<form method="post" id="questionForm">	
			...
			<s:if test="%{type == 'note'}">
				<table  align="left" border="0">
					<tr>
						<td align="right" width="20%"><font color=red>*</font>备注内容:</td>
						<td width="60%">						
			...
			<s:else>	
				<table  align="left" border="0">
					...
					<tr>
						<td align="right" width="20%" valign="middle"><font color=red>*</font> 答案长度:</td>
						<td width="60%">						
						    <s:textfield name="question.answerLength" labelposition="top" size="5" theme="simple" ></s:textfield>
